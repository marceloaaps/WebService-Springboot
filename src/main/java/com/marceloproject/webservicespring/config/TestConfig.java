...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args){
        ...
        Order o1 = new Order(null, Instant.parse("2024-08-21T14:52:01Z"), u1);
        Order o2 = new Order(null, Instant.parse("2024-08-22T16:53:14Z"), u1);
        Order o3 = new Order(null, Instant.parse("2024-06-15T21:34:55Z"), u2);
